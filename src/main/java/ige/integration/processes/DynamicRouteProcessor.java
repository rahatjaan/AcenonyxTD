...
<<<<<<< HEAD:src/main/java/com/integration/td/processes/DynamicRouteProcessor.java
	            }else if(Constants.RECEIVETDORDER.equalsIgnoreCase(flow)){
	            	// TODO: Have to send soap request here
	            	//soapResponse = soapConnection.call(createSOAPRequestForReceiveTDOrder(req), url);
	            	System.out.println(req);
	            	flow = Constants.GUESTCHECKIN;
...
=======
>>>>>>> 9011a142512171f71dc9078d9bf19ce5020fa952:src/main/java/ige/integration/processes/DynamicRouteProcessor.java
	            }
